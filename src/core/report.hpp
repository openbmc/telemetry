    ...
    public std::enable_shared_from_this<core::Report<Strategy>>
{
  public:
    ...
    void setCallback(ReadingsUpdatedCallback&& callback) override
    {
  ...
  private:
    static constexpr auto defaultScanPeriod = std::chrono::milliseconds(100);
    ...
    ReadingsUpdatedCallback readingsUpdated_ = nullptr;
