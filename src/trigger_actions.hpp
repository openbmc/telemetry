...
constexpr const char* TriggerNumericWarning =
    "OpenBMC.0.1.0.TriggerNumericWarning";
constexpr const char* TriggerNumericCritical =
    "OpenBMC.0.1.0.TriggerNumericCritical";
constexpr const char* TriggerDiscreteOK = "OpenBMC.0.1.0.TriggerDiscreteOK";
constexpr const char* TriggerDiscreteWarning =
    "OpenBMC.0.1.0.TriggerDiscreteWarning";
constexpr const char* TriggerDiscreteCritical =
    "OpenBMC.0.1.0.TriggerDiscreteCritical";
} // namespace redfish_message_ids
...
class LogToJournal : public interfaces::TriggerAction
{
  public:
    ...
    void commit(const std::string& triggerId, ThresholdName thresholdName,
                const std::string& sensorName, Milliseconds timestamp,
                TriggerValue value) override;
