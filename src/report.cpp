...
Report::Report(boost::asio::io_context& ioc,
    ...
    appendLimit(appendLimitIn), sensorCount(getSensorCount(metricsIn)),
...
ReportUpdates Report::deduceReportUpdates(const ReportUpdates reportUpdatesIn,
                                          const ReportingType reportingTypeIn)
{
...
std::unique_ptr<sdbusplus::asio::dbus_interface> Report::makeReportInterface()
{
    ...
    dbusIface->register_property_rw(
        ...
        sdbusplus::vtable::property_::emits_change,
        [this](std::string newVal, auto& oldVal) {
...
void Report::updateReadings()
{
    ...
    else if (reportUpdates == ReportUpdates::AppendStopsWhenFull &&
