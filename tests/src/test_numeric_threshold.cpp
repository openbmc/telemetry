...
struct TestThresholdParams
{
    ...
    std::vector<std::tuple<uint64_t, double>> expectedCommit;
};
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(TestThresholdParams{numeric::Direction::increasing,
                               {{0, 1, 80.0}, {0, 2, 89.0}},
                               {}},
           TestThresholdParams{numeric::Direction::increasing,
                               {{0, 1, 80.0}, {0, 2, 91.0}},
                               {{2, 91.0}}},
           TestThresholdParams{
               numeric::Direction::increasing,
               {{0, 1, 80.0}, {0, 2, 99.0}, {0, 3, 80.0}, {0, 4, 98.0}},
               {{2, 99.0}, {4, 98.0}}},
           TestThresholdParams{
               numeric::Direction::increasing,
               {{0, 1, 80.0}, {0, 2, 99.0}, {1, 3, 100.0}, {1, 4, 98.0}},
               {{2, 99.0}}},
           TestThresholdParams{numeric::Direction::decreasing,
                               {{0, 1, 100.0}, {0, 2, 91.0}},
                               {}},
           TestThresholdParams{numeric::Direction::decreasing,
                               {{0, 1, 100.0}, {0, 2, 80.0}},
                               {{2, 80.0}}},
           TestThresholdParams{
               numeric::Direction::decreasing,
               {{0, 1, 100.0}, {0, 2, 80.0}, {0, 3, 99.0}, {0, 4, 85.0}},
               {{2, 80.0}, {4, 85.0}}},
           TestThresholdParams{
               numeric::Direction::decreasing,
               {{0, 1, 100.0}, {0, 2, 80.0}, {1, 3, 99.0}, {1, 4, 88.0}},
               {{2, 80.0}, {4, 88.0}}},
           TestThresholdParams{
               numeric::Direction::either, {{0, 1, 98.0}, {0, 2, 91.0}}, {}},
           TestThresholdParams{
               numeric::Direction::either,
               {{0, 1, 100.0}, {0, 2, 80.0}, {0, 3, 85.0}, {0, 4, 91.0}},
               {{2, 80.0}, {4, 91.0}}},
           TestThresholdParams{
               numeric::Direction::either,
               {{0, 1, 100.0}, {1, 2, 80.0}, {0, 3, 85.0}, {1, 4, 91.0}},
               {{3, 85.0}, {4, 91.0}}}));

TEST_P(TestNumericThresholdNoDwellTime, senorsIsUpdatedMultipleTimes)
{
    InSequence seq;
    for (const auto& [timestamp, value] : GetParam().expectedCommit)
    {
        EXPECT_CALL(actionMock, commit(timestamp, value));
    }
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(TestThresholdParams{numeric::Direction::increasing,
           ...
           TestThresholdParams{
               numeric::Direction::increasing,
               {{0, 1, 80.0}, {1, 2, 99.0}, {0, 3, 100.0}, {1, 4, 86.0}},
               {{3, 100.0}}},
           TestThresholdParams{numeric::Direction::decreasing,
                               {{0, 1, 100.0}, {0, 2, 91.0}},
                               {}},
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(TestThresholdParams{numeric::Direction::increasing,
           ...
           TestThresholdParams{
               numeric::Direction::increasing,
               {{0, 1, 80.0}, {1, 2, 99.0}, {0, 3, 100.0}, {1, 4, 98.0}},
               {{3, 100.0}}},
           TestThresholdParams{numeric::Direction::decreasing,
                               {{0, 1, 100.0}, {0, 2, 91.0}},
                               {}},
