...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(DiscreteParams()
               .DwellTime(2ms)
               .ThresholdValue(90.0)
               .Updates({{0, 1, 90.0, 1ms}, {0, 2, 91.0}, {0, 3, 90.0}})
               .Expected({{0, 3, 90.0, 3ms}}),
           DiscreteParams()
               .DwellTime(1ms)
               .ThresholdValue(90.0)
               .Updates({{0, 1, 90.0, 1ms}})
               .Expected({{0, 1, 90.0, 1ms}}),
           DiscreteParams()
               .DwellTime(10ms)
               .ThresholdValue(90.0)
               .Updates({{0, 1, 90.0, 7ms},
                         {0, 1, 91.0, 1ms},
                         {0, 1, 90.0, 3ms},
                         {0, 1, 91.0, 1ms}})
               .Expected({}),
           DiscreteParams()
               ...
               .Updates({{0, 1, 90.0},
                         ...
                         {1, 5, 90.0, 3ms},
                         {1, 6, 89.0, 1ms}})
               .Expected({{0, 1, 90, 2ms}, {1, 5, 90, 5ms}})));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(DiscreteParams()
           ...
           DiscreteParams()
               ...
               .Expected({{0, 1, 81.0, 5ms}}),
           DiscreteParams()
               .DwellTime(5ms)
               .Updates({{0, 1, 80.0, 1ms}, {0, 1, 81.0, 1ms}})
               .Expected({{0, 1, 81.0, 6ms}}),
           DiscreteParams()
               .DwellTime(2ms)
               .Updates({{0, 1, 80.0},
                         {0, 2, 81.0},
                         ...
                         {1, 7, 89.0, 2ms}})
               .Expected(
                   {{0, 2, 81.0, 2ms}, {1, 6, 90.0, 5ms}, {1, 7, 89.0, 7ms}}),
           DiscreteParams()
               .DwellTime(3ms)
               .Updates({{0, 1, 90.0},
                         {0, 2, 91.0, 1ms},
