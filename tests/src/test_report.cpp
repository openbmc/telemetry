...
TEST_F(TestReport, verifyIfPropertiesHaveValidValue)
{
    ...
    EXPECT_THAT(getProperty<std::string>(sut->getPath(), "UpdatePolicy"),
                Eq("Overwrite"));
    EXPECT_THAT(
...
struct UpdatePolicyReportParams
{
    ReportParams reportParams;
    std::vector<ReadingData> expectedReadings;
};

class TestReportWithUpdatePolicyAndLimit :
    public TestReport,
    public WithParamInterface<UpdatePolicyReportParams>
{
    void SetUp() override
    {
...
INSTANTIATE_TEST_SUITE_P(
    AppendWrapWhenFull, TestReportWithUpdatePolicyAndLimit,
    Values(
        UpdatePolicyReportParams{
            ReportParams().updatePolicy("AppendWrapWhenFull").appendLimit(5),
            std::vector<ReadingData>{
                {std::make_tuple("aa"s, "bb"s, 42.0, 74u),
                 ...
                 std::make_tuple("a"s, "b"s, 17.1, 114u)}}},
        UpdatePolicyReportParams{
            ReportParams().updatePolicy("AppendWrapWhenFull").appendLimit(4),
            std::vector<ReadingData>{
                {std::make_tuple("a"s, "b"s, 17.1, 114u),
                 std::make_tuple("aa"s, "bb"s, 42.0, 74u),
                 std::make_tuple("a"s, "b"s, 17.1, 114u),
                 std::make_tuple("aa"s, "bb"s, 42.0, 74u)}}},
        UpdatePolicyReportParams{
            ReportParams().updatePolicy("AppendWrapWhenFull").appendLimit(0),
            std::vector<ReadingData>{}},
        UpdatePolicyReportParams{
            ReportParams().updatePolicy("AppendStopWhenFull").appendLimit(5),
            std::vector<ReadingData>{
                {std::make_tuple("a"s, "b"s, 17.1, 114u),
                 std::make_tuple("aa"s, "bb"s, 42.0, 74u),
                 std::make_tuple("a"s, "b"s, 17.1, 114u),
                 ...
                 std::make_tuple("a"s, "b"s, 17.1, 114u)}}},
        UpdatePolicyReportParams{
            ReportParams().updatePolicy("AppendStopWhenFull").appendLimit(4),
            std::vector<ReadingData>{
                {std::make_tuple("a"s, "b"s, 17.1, 114u),
                 std::make_tuple("aa"s, "bb"s, 42.0, 74u),
                 std::make_tuple("a"s, "b"s, 17.1, 114u),
                 std::make_tuple("aa"s, "bb"s, 42.0, 74u)}}},
        UpdatePolicyReportParams{
            ReportParams().updatePolicy("AppendStopWhenFull").appendLimit(0),
            std::vector<ReadingData>{}},
        UpdatePolicyReportParams{
            ReportParams().updatePolicy("Overwrite").appendLimit(500),
            std::vector<ReadingData>{
                {std::make_tuple("a"s, "b"s, 17.1, 114u),
                 std::make_tuple("aa"s, "bb"s, 42.0, 74u)}}},
        UpdatePolicyReportParams{
            ReportParams().updatePolicy("Overwrite").appendLimit(1),
            std::vector<ReadingData>{
                {std::make_tuple("a"s, "b"s, 17.1, 114u)}}},
        UpdatePolicyReportParams{
            ReportParams().updatePolicy("Overwrite").appendLimit(0),
            std::vector<ReadingData>{}}));

TEST_P(TestReportWithUpdatePolicyAndLimit,
