  ...
  public:
    ...
    std::unique_ptr<Report> makeReport(const ReportParams& params)
    {
        ...
        return std::make_unique<Report>(
            ...
            stringToReportUpdates(params.recordUpdates()), *reportManagerMock,
            storageMock,
...
struct RecordUpdatesReportParams
{
    ReportParams reportParams;
    std::vector<ReadingData> expectedReadings;
};

class TestReportWithRecordUpdatesAndLimit :
    public TestReport,
    public WithParamInterface<RecordUpdatesReportParams>
{
    void SetUp() override
    {
...
INSTANTIATE_TEST_SUITE_P(
    AppendWrapWhenFull, TestReportWithRecordUpdatesAndLimit,
    Values(
        RecordUpdatesReportParams{
            ReportParams().recordUpdates("AppendWrapWhenFull").appendLimit(5),
            std::vector<ReadingData>{
                {std::make_tuple("aa"s, "bb"s, 42.0, 74u),
                 ...
                 std::make_tuple("a"s, "b"s, 17.1, 114u)}}},
        RecordUpdatesReportParams{
            ReportParams().recordUpdates("AppendWrapWhenFull").appendLimit(4),
            std::vector<ReadingData>{
                {std::make_tuple("a"s, "b"s, 17.1, 114u),
                 std::make_tuple("aa"s, "bb"s, 42.0, 74u),
                 std::make_tuple("a"s, "b"s, 17.1, 114u),
                 std::make_tuple("aa"s, "bb"s, 42.0, 74u)}}},
        RecordUpdatesReportParams{
            ReportParams().recordUpdates("AppendWrapWhenFull").appendLimit(0),
            std::vector<ReadingData>{}},
        RecordUpdatesReportParams{
            ReportParams().recordUpdates("AppendStopWhenFull").appendLimit(5),
            std::vector<ReadingData>{
                {std::make_tuple("a"s, "b"s, 17.1, 114u),
                 std::make_tuple("aa"s, "bb"s, 42.0, 74u),
                 std::make_tuple("a"s, "b"s, 17.1, 114u),
                 ...
                 std::make_tuple("a"s, "b"s, 17.1, 114u)}}},
        RecordUpdatesReportParams{
            ReportParams().recordUpdates("AppendStopWhenFull").appendLimit(4),
            std::vector<ReadingData>{
                {std::make_tuple("a"s, "b"s, 17.1, 114u),
                 std::make_tuple("aa"s, "bb"s, 42.0, 74u),
                 std::make_tuple("a"s, "b"s, 17.1, 114u),
                 std::make_tuple("aa"s, "bb"s, 42.0, 74u)}}},
        RecordUpdatesReportParams{
            ReportParams().recordUpdates("AppendStopWhenFull").appendLimit(0),
            std::vector<ReadingData>{}},
        RecordUpdatesReportParams{
            ReportParams().recordUpdates("Overwrite").appendLimit(500),
            std::vector<ReadingData>{
                {std::make_tuple("a"s, "b"s, 17.1, 114u),
                 std::make_tuple("aa"s, "bb"s, 42.0, 74u)}}},
        RecordUpdatesReportParams{
            ReportParams().recordUpdates("Overwrite").appendLimit(1),
            std::vector<ReadingData>{
                {std::make_tuple("a"s, "b"s, 17.1, 114u)}}},
        RecordUpdatesReportParams{
            ReportParams().recordUpdates("Overwrite").appendLimit(0),
            std::vector<ReadingData>{}}));

TEST_P(TestReportWithRecordUpdatesAndLimit,
