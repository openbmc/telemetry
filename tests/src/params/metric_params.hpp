...
class MetricParams final
{
  public:
    ...
    MetricParams& readings(std::vector<std::pair<DurationType, double>> value)
    {
    ...
    const std::vector<std::pair<DurationType, double>>& readings() const
    {
        return readingsProperty;
    }

    MetricParams& expectedReading(DurationType delta, double reading)
    {
