...
class ReportParams final
{
  public:
    ...
    ReportParams& recordUpdates(std::string val)
    {
        recordUpdatesProperty = val;
        return *this;
    }

    std::string recordUpdates() const
    {
        return recordUpdatesProperty;
    }
  ...
  private:
    ...
    std::string recordUpdatesProperty = "Default";
