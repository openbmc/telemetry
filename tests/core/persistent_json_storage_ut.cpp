...
class ReportPersistentJsonStorage : public Test
{
  public:
    ...
    const core::interfaces::JsonStorage::Resource fileName =
        "report/1/file.txt";

    static const core::interfaces::JsonStorage::Resource directory;
    PersistentStorage sut{directory};
};

const core::interfaces::JsonStorage::Resource
    ReportPersistentJsonStorage::directory = std::tmpnam(nullptr);
